...
- 统一已有、未创建和重复 Daily Note 的栏位展示，浏览不会自动创建文档

### Fixed

- 修复日历异步查询结果滞后覆盖和结果不触发渲染的问题
- 创建 Daily Note 失败时显示错误提示并恢复重试能力

## [2026-06-05] v1.9.0

- ✨ feat: 新增 Daily Note View，用一个自定义页签按 `日期 × 笔记本` 浏览 Daily Note
- ✨ feat: 支持今日、三日、笔记本、周、月视图；周/月视图显示跨笔记本日记状态
- ✨ feat: 缺失日记只在点击「创建 Daily Note」时写入，浏览不会自动创建文档
- ✨ feat: 多栏笔记视图支持在设置中配置最小栏宽
- 🐛 fix: 优化 Daily Note View 的工具栏、日历刷新、Protyle 渲染和多栏布局稳定性
...
## [2024-04-26] v1.6.0: 优化「补充属性」功能

- 🐛 fix: [#191](https://github.com/frostime/siyuan-dailynote-today/issues/191)
