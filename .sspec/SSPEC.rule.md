...
`spec.md` / `design.md` MUST contain the latest accepted contract; semantic evolution → causal revision + current documents + `tasks.md` + `spec.md` Evolution History, synchronized before implementation resumes.
No Evolution History section → legacy immutable-baseline protocol.
